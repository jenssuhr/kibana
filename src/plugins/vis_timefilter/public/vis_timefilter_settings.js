define(function (require) {
  var module = require('ui/modules').get('visualize');

  module.directive('visTimefilterSettings', function ($parse, $compile) {
    return {
      restrict: 'E',
      template: require('plugins/vis_timefilter/vis_timefilter_settings.html'),
      scope: {
        vis: '=',
      },
